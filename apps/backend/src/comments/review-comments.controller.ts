...
/**
 * S1 §13.7 — `GET /reviews/{id}/comments`. Soft-gate readable. Flat list ordered
...
export class ReviewCommentsController {
  ...
  @Get(':id/comments')
  listReviewComments(@Param() params: CommentHostIdParamDto): Promise<CommentResponse[]> {
    return this.commentsService.listByHost('review', params.id);
  }
}
