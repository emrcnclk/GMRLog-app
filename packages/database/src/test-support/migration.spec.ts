...
describe('initial migration', () => {
  ...
  it('materializes the full S2 entity catalog as tables', async () => {
    ...
    // 85 tables as of D11.1 (adds 1: sync_cursors — the bulk catalog sync's
    // durable high-water mark, TASKS.md §11.1). Was 84 as of D3.25 (adds 7:
    // game_series, tags, game_tags, companies, game_companies,
